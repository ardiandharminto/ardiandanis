                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('update.portfolio') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="portfolio_name" class="form-control" type="text" id="portfolio_name" value="{{ $portfolio->portfolio_name }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="portfolio_title" class="form-control" type="text" id="portfolio_title" value="{{ $portfolio->portfolio_title }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg" src="{{ asset($portfolio->portfolio_image) }}" alt="Image Preview">
                                    </div>
                                </div>
                                <!-- end row -->
