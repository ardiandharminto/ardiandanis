            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="menu__wrap">
                        <nav class="menu__nav">
                            <div class="logo">
                                <a href="{{ route('home') }}" class="logo__black"><img src="{{ asset('frontend/assets/img/logo/logo_new.png') }}" alt=""></a>
                                <a href="{{ route('home') }}" class="logo__white"><img src="{{ asset('frontend/assets/img/logo/logo_new.png') }}" alt=""></a>
                            </div>
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    ...
                                    <li class="{{ ($route == 'home.blog') ? 'active' : '' }}">
                                        <a href="{{ route('home.blog') }}">My Blog</a>
                                    </li>
                    ...
                    <div class="mobile__menu">
                        <nav class="menu__box">
                            ...
                            <div class="social-links">
                                <ul class="clearfix">
                                    <li><a href="https://www.twitter.com/ardyandanys"><span class="fab fa-twitter"></span></a></li>
                                    {{-- <li><a href="#"><span class="fab fa-facebook-square"></span></a></li> --}}
                                    {{-- <li><a href="#"><span class="fab fa-pinterest-p"></span></a></li> --}}
                                    <li><a href="https://www.instagram.com/ardyandanys"><span class="fab fa-instagram"></span></a></li>
