...
@section('main')
    ...
    @section('title') About | Ardian Danis Website @endsection
            ...
            <div class="breadcrumb__wrap__icon">
                <ul>
                    @foreach ($multiImages as $multi_image)
                        <li><img src="{{ $multi_image->multi_image }}" alt=""></li>
                    @endforeach
                </ul>
            </div>
        </section>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="about__education__item">
                                                    <h3 class="title">Computer Science - Dian Nuswantoro University</h3>
                                            ...
                                            <div class="col-md-6">
                                                <div class="about__education__item">
                                                    <h3 class="title">SMA Negeri 3 Semarang</h3>
                                            ...
                                            <div class="col-md-6">
                                                <div class="about__education__item">
                                                    <h3 class="title">SMP Negeri 2 Semarang</h3>
                            ...
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    ...
                                    <div class="blog__post__tags">
                                        <a href="{{ route('category.blog', $blog->blog_category_id) }}">{{ $blog['category']['blog_category'] }}</a>
                                    </div>
                                </div>
